...
<div class="center-content">
    ...
    <div class="bot-content">
        <table>
            ...
            <tbody>
            <?php $i=0;$phone_list = [];$email_list=[]; foreach ($data['khachhang_list'] as $kh) {
        ...
        <div class="xacnhan-delete" id="xacnhan-delete-cus">
        <div class="text-xacnhan" id="text-xacnhan" >Xác nhận xóa khách hàng <span id="id-dele"></span> ?</div>
            <button type="submit" class="bnt-select" id="btn-delete" name="delete-cus">OK</button>
            <div class="bnt-select" id="btn-back" onclick="exitXacnhan('xacnhan-delete-cus')">Không</div>
        </div>
            ...
            <div style="height:400px" class="view-info">
                ...
                <div class="info">
                    ...
                    <div class="input-info">
                        <ul class="input">
                            <li >
                                <input type="text" id="id-cus-input" name="id-cus-input" class="li"  placeholder="Nhập mã" value="<?php echo $data['newid'];?>" readonly>
